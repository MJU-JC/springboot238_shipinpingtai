...
public class TiyuCollectionView extends TiyuCollectionEntity implements Serializable {
	...
	public TiyuCollectionView() {

	}

	public TiyuCollectionView(TiyuCollectionEntity tiyuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, tiyuCollectionEntity);
