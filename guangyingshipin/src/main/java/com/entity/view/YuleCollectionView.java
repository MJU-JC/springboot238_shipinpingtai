...
public class YuleCollectionView extends YuleCollectionEntity implements Serializable {
	...
	public YuleCollectionView() {

	}

	public YuleCollectionView(YuleCollectionEntity yuleCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, yuleCollectionEntity);
