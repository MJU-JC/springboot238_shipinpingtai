 ...
 */
@TableName("nba_collection")
public class NbaCollectionView extends NbaCollectionEntity implements Serializable {
	...
	public NbaCollectionView() {

	}

	public NbaCollectionView(NbaCollectionEntity nbaCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, nbaCollectionEntity);
