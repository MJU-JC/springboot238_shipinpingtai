...
public class PapiLiuyanView extends PapiLiuyanEntity implements Serializable {
	...
	public PapiLiuyanView() {

	}

	public PapiLiuyanView(PapiLiuyanEntity papiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, papiLiuyanEntity);
