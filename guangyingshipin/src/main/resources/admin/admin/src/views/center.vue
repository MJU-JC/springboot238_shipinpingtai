<template>
  <div>
    ...
    >  
     <el-row>
                                     <el-col :span="12">
                              <el-form-item v-if="flag=='yonghu'"  label='用户昵称' prop="yonghuName">
                                  <el-input v-model="ruleForm.yonghuName"  placeholder='用户昵称' clearable></el-input>
                              </el-form-item>
                          </el-col>
                        ...
                        <el-col :span="24">
                            <el-form-item v-if="flag=='yonghu'" label='用户照片' prop="yonghuPhoto">
                                <file-upload
                                        tip="点击上传照片"
                                        action="file/upload"
                                        :limit="3"
