        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yishuPhoto" label="艺术照片" prop="yishuPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.yishuPhoto?ruleForm.yishuPhoto:''"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yishuVideo" label="艺术视频" prop="yishuVideo">
                        <file-upload
                            tip="点击上传艺术视频"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.yishuVideo?ruleForm.yishuVideo:''"
                            @change="yishuVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yishuVideo" label="艺术视频" prop="yishuVideo">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yishuVideo.split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="艺术类型" prop="yishuTypes">
                        <el-select v-model="ruleForm.yishuTypes" placeholder="请选择艺术类型">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="艺术简介" prop="yishuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yishuContent" label="艺术简介" prop="yishuContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   yishuVideo: [
                              { required: true, message: '艺术视频不能为空', trigger: 'blur' },
                          ],
                   yishuTypes: [
                   ...
                   yishuContent: [
                              { required: true, message: '艺术简介不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yishuName'){
                          this.ruleForm.yishuName = obj[o];
                          this.ro.yishuName = true;
                          continue;
                      }
                      if(o=='yishuPhoto'){
                          this.ruleForm.yishuPhoto = obj[o];
                          this.ro.yishuPhoto = true;
                          continue;
                      }
                      if(o=='yishuVideo'){
                          this.ruleForm.yishuVideo = obj[o];
                          this.ro.yishuVideo = true;
                          continue;
                      }
                      if(o=='yishuTypes'){
                          this.ruleForm.yishuTypes = obj[o];
                          this.ro.yishuTypes = true;
                          continue;
                      }
                      if(o=='yishuClicknum'){
                          this.ruleForm.yishuClicknum = obj[o];
                          this.ro.yishuClicknum = true;
                          continue;
                      }
                      if(o=='shangxiaTypes'){
                      ...
                      if(o=='yishuDelete'){
                          this.ruleForm.yishuDelete = obj[o];
                          this.ro.yishuDelete = true;
                          continue;
                      }
                      if(o=='yishuContent'){
                          this.ruleForm.yishuContent = obj[o];
                          this.ro.yishuContent = true;
                          continue;
                      }
                    }
                }
            ...
            yishuVideoUploadChange(fileUrls){
                this.ruleForm.yishuVideo = fileUrls;
                this.addEditUploadStyleChange()
            },
