...
<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yishu'">
                    <el-form-item class="select" v-if="type!='info'"  label="艺术" prop="yishuId">
                        <el-select v-model="ruleForm.yishuId" filterable placeholder="请选择艺术" @change="yishuChange">
                            <el-option
                                    v-for="(item,index) in yishuOptions"
                                    v-bind:key="item.id"
                                    :label="item.yishuName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='yishu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="艺术名称" prop="yishuName">
                        <el-input v-model="yishuForm.yishuName"
                                  placeholder="艺术名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="24" v-if="sessionTable !='yishu' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yishuPhoto" label="艺术照片" prop="yishuPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (yishuForm.yishuPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yishuPhoto" label="艺术照片" prop="yishuPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.yishuPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yishu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="艺术类型" prop="yishuValue">
                        <el-input v-model="yishuForm.yishuValue"
                                  placeholder="艺术类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yishu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="yishuClicknum">
                        <el-input v-model="yishuForm.yishuClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="yishuClicknum">
                            <el-input v-model="ruleForm.yishuClicknum"
            ...
            <input id="yishuId" name="yishuId" type="hidden">
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="yishuLiuyanText">
                        <el-input type="textarea"  :readonly="ro.yishuLiuyanText" v-model="ruleForm.yishuLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yishuLiuyanText" label="留言内容" prop="yishuLiuyanText">
                            <span v-html="ruleForm.yishuLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   yishuId: [
                              { required: true, message: '艺术不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
         ...
         this.$http({
             url: `yishu/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.yishuOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yishuId'){
                          this.ruleForm.yishuId = obj[o];
                          this.ro.yishuId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='yishuLiuyanText'){
                          this.ruleForm.yishuLiuyanText = obj[o];
                          this.ro.yishuLiuyanText = true;
                          continue;
                      }
                      if(o=='replyText'){
            ...
            info(id) {
                this.$http({
                    url: `yishuLiuyan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.ruleForm = data.data;
                        this.yishuChange(data.data.yishuId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yishuLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yishuLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
